  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            <Reveal>
              ...
              <p className="font-mono text-sm text-fawn-muted leading-relaxed">Telecom brands face intense competition and need to communicate complex network capabilities (5G, fiber, IoT) in ways that resonate with diverse consumer segments — from tech enthusiasts to everyday mobile users.</p>
            </Reveal>
            <Reveal delay={0.1}>
              <h2 className="font-editorial text-4xl text-fawn mb-8">Our Solution</h2>
              <p className="font-mono text-sm text-fawn-muted leading-relaxed">We translate technical capabilities into emotionally engaging visual stories. Our motion graphics transform complex network infrastructure into accessible, compelling narratives that drive brand preference.</p>
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-abyss">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal><h2 className="font-editorial text-4xl text-fawn mb-16">Animation Services for Telecom</h2></Reveal>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <Reveal delay={0.1}>
              ...
              <h2 className="font-editorial text-4xl text-fawn mt-4 mb-6">Connect Bahrain</h2>
              <p className="font-mono text-sm text-fawn-muted mb-8">Launched a 12-piece animated social campaign for a Bahrain telecom&apos;s new 5G network rollout. Each piece highlighted a different use case (streaming, gaming, remote work) with custom 3D network visualizations.</p>
