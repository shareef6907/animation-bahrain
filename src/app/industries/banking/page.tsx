  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            <Reveal>
              ...
              <p className="font-mono text-base text-fawn-muted max-w-prose leading-relaxed">Bahrain&apos;s banking sector operates in a highly regulated, trust-dependent environment. Financial products are complex and traditional explainer content often fails to engage digitally-native customers.</p>
            </Reveal>
            <Reveal delay={0.1}>
              ...
              <p className="font-mono text-base text-fawn-muted max-w-prose leading-relaxed">We create animated content that demystifies financial products without oversimplifying. Our explainer animations build trust through clarity — helping banks connect with the next generation of customers while maintaining regulatory confidence.</p>
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 lg:py-40 bg-abyss">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal><h2 className="font-editorial text-4xl md:text-5xl lg:text-6xl text-fawn mb-16">Animation Services for Banking</h2></Reveal>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <Reveal delay={0.1}>
              ...
              <h2 className="font-editorial text-4xl md:text-5xl lg:text-6xl text-fawn mt-4 mb-6">Al Majd Islamic Banking</h2>
              <p className="font-mono text-base text-fawn-muted max-w-prose mb-8">Created a 6-part animated series explaining Islamic banking products for a major Bahrain bank. The series achieved 340% higher engagement rates compared to their previous static content approach.</p>
