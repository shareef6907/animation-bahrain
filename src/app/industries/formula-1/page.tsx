...
export const metadata: Metadata = {
  title: "Formula 1 Animation Services | Motorsport Video Production",
  description: "Animation and motion graphics for Formula 1 sponsors, racing teams, and motorsport promotional content across the GCC. Broadcast-quality visuals for the world's premier racing series.",
};

const services = [
  "Race Highlights Animation",
  "Sponsor Acknowledgment Graphics",
  "Motorsport Social Content",
...
const serviceDescriptions: Record<string, string> = {
  "Race Highlights Animation": "Cinematic race recap animations that capture the energy and drama of Formula 1 racing.",
  "Sponsor Acknowledgment Graphics": "Broadcast-ready sponsor logos and acknowledgment animations for race weekend and beyond.",
  "Motorsport Social Content": "Engaging social media content optimized for each platform during race weekends and off-season.",
    ...
    <>
      ...
      <section className="min-h-screen flex items-center justify-center bg-abyss relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 pt-32 text-center">
          ...
          <Reveal delay={0.1}>
            <h1 className="font-editorial text-6xl md:text-8xl text-fawn mt-6 mb-6">Formula 1</h1>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="font-mono text-sm text-fawn-muted max-w-2xl mx-auto mb-10">Formula 1 is the world's most-watched annual sporting series, commanding premium sponsorship budgets and broadcast standards. Creating content that matches that prestige requires speed, precision, and F1-level visual quality. We deliver broadcast-quality animations that keep pace with racing schedules — wherever the calendar takes you.</p>
          </Reveal>
          <Reveal delay={0.3}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            <Reveal>
              ...
              <p className="font-mono text-base text-fawn-muted max-w-prose leading-relaxed">F1 sponsors and racing teams need high-impact visual content that matches the prestige and energy of the world's premier racing series — but traditional animation production timelines don't align with racing schedules.</p>
            </Reveal>
            <Reveal delay={0.1}>
      ...
      <section className="py-32 lg:py-40 bg-abyss">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal><h2 className="font-editorial text-4xl md:text-5xl lg:text-6xl text-fawn mb-16">Animation Services for Formula 1</h2></Reveal>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <Reveal delay={0.1}>
              ...
              <h2 className="font-editorial text-4xl md:text-5xl lg:text-6xl text-fawn mt-4 mb-6">Motorsport Sponsor Package</h2>
              <p className="font-mono text-base text-fawn-muted max-w-prose mb-8">We delivered a complete sponsor acknowledgment animation package for a regional logistics brand with Formula 1 sponsorship presence. The 45-second broadcast-ready piece aired during race weekend across multiple MENA networks.</p>
