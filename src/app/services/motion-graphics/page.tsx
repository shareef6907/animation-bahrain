    ...
    <>
      ...
      <section className="py-32 lg:py-40 bg-night">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal><h2 className="font-editorial text-4xl md:text-5xl lg:text-6xl text-fawn">What We Deliver</h2></Reveal>
            ...
            {features.map((f, i) => (
              <Reveal key={f} delay={i * 0.07}>
                <div className="p-10 rounded-2xl bg-surface border border-white/5 hover:border-white/20 transition-colors">
                  <p className="font-mono text-base text-fawn">{f}</p>
                </div>
              </Reveal>
            ))}
          </div>
      ...
      <section className="py-32 lg:py-40 bg-abyss">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              <div>
                <h2 className="font-editorial text-4xl md:text-5xl lg:text-6xl text-fawn mt-4 mb-16">Ideal For</h2>
                <p className="font-mono text-base text-fawn-muted max-w-prose leading-relaxed mb-16">Motion graphics transform static brands into dynamic experiences. Whether you are a startup in Bahrain launching your identity or a corporation in Saudi Arabia refreshing your presentation style, our motion design elevates every touchpoint.</p>
      ...
      <section className="py-32 lg:py-40 bg-night">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal><h2 className="font-editorial text-4xl md:text-5xl lg:text-6xl text-fawn mt-4 mb-16">Our Process</h2></Reveal>
          <div className="space-y-6">
            {steps.map((step, i) => (
              <Reveal key={step} delay={i * 0.08}>
                <div className="flex items-center gap-8 p-10 rounded-2xl bg-surface/50 border border-white/5 hover:border-white/20 transition-colors">
                  <span className="font-mono text-xs text-amber w-8">0{i + 1}</span>
                  <span className="font-mono text-base text-fawn max-w-prose">{step}</span>
                </div>
              </Reveal>
            ))}
          </div>
      ...
      <section className="py-32 lg:py-40 bg-abyss relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center px-6">
          ...
          <Reveal delay={0.1}><p className="font-mono text-base text-fawn-muted max-w-prose leading-relaxed mb-10">Free consultation, no commitment.</p></Reveal>
