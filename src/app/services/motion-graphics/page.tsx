          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              <div>
                ...
                <p className="font-mono text-sm text-fawn-muted mb-8">Motion graphics transform static brands into dynamic experiences. Whether you are a startup in Bahrain launching your identity or a corporation in Saudi Arabia refreshing your presentation style, our motion design elevates every touchpoint.</p>
