          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              <div>
                ...
                <p className="font-mono text-base text-fawn-muted max-w-prose leading-relaxed mb-16">Explainer videos simplify complex messages into digestible visual stories. From tech startups in Bahrain launching SaaS products to corporations in Dubai training employees, our explainer videos help audiences understand and remember your message.</p>
