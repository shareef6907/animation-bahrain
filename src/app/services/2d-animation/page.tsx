    ...
    <>
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-abyss">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-6 pt-32">
          ...
          <Reveal delay={0.2}>
            <p className="font-mono text-sm text-fawn-muted max-w-2xl mx-auto mb-10">Bring stories to life with our expert 2D animation services in Bahrain. From character-driven narratives to sleek commercial spots, we craft visuals that captivate audiences across the GCC and Middle East.</p>
          </Reveal>
          <Reveal delay={0.3}>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              <div>
                ...
                <p className="font-mono text-base text-fawn-muted max-w-prose leading-relaxed mb-16">Our 2D animation services are perfect for brands looking to connect emotionally with their audience through storytelling. We create content that resonates across Bahrain, Saudi Arabia, UAE, and the wider GCC market.</p>
