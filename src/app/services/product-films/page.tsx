...
import { ShoppingCart, Smartphone, Store, Users, Rocket, Wrench } from "lucide-react";
...
const features = [
  {
    name: "Feature-to-Drama",
    description: "Transform specifications into compelling visual narratives.",
    Icon: ShoppingCart,
  },
  {
    name: "Multi-Format Output",
    description: "Cinema, broadcast, and social cuts from a single production.",
    Icon: Smartphone,
  },
  {
    name: "E-Commerce Ready",
    description: "Videos optimised for Shopify, Amazon, and major platforms.",
    Icon: Store,
  },
  {
    name: "Lifestyle Integration",
    description: "Products shown in context, in use, in life.",
    Icon: Users,
  },
  {
    name: "Technical Precision",
    description: "Accurate, detailed product demonstrations that build trust.",
    Icon: Wrench,
  },
  {
    name: "Brand Coherence",
    description: "Every cut consistent with your brand identity system.",
    Icon: Rocket,
  },
];
    ...
    <>
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-abyss">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-6 pt-32">
          ...
          <Reveal delay={0.2}>
            <p className="font-mono text-base text-fawn-muted max-w-2xl mx-auto mb-10 leading-relaxed">Product films that sell without feeling like sales pitches. We transform features into drama, specifications into desire. From 30-second social cuts to full e-commerce experiences. For brands who know their product deserves to be seen.</p>
          </Reveal>
          <Reveal delay={0.3}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <Reveal delay={0.1}>
            <p className="font-mono text-base text-fawn-muted max-w-prose leading-relaxed mb-16">
              Precision production that makes every product look exceptional.
            </p>
          </Reveal>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <Reveal delay={0.1}>
            <p className="font-mono text-base text-fawn-muted max-w-prose leading-relaxed mb-12">
              Product films transform how your audience engages with what you sell. From e-commerce brands in the UAE showcasing products online to retailers across the GCC preparing for trade shows, our production elevates every product presentation.
            </p>
          </Reveal>
