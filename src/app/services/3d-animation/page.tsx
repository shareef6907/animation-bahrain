          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              <div>
                ...
                <p className="font-mono text-sm text-fawn-muted mb-8">Our 3D animation services transform how brands present products, properties, and stories. From Dubai real estate developers to Riyadh-based gaming companies, we serve clients across the GCC with world-class 3D production.</p>
